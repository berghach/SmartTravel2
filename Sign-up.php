            ...
            <div class="card-body p-5">
              ...
              <form>
                ...
                <div class="form-outline mb-4">
                  ...
                  <input type="text" id="form3Example1cg" class="form-control form-control-lg" require />
                </div>

                <div class="form-outline mb-4">
                <label class="form-label" for="form3Example3cg">Your Email</label>
                 <input type="email" id="form3Example3cg" class="form-control form-control-lg" require />
                 </div>

                <div class="form-outline mb-4">
                <label class="form-label" for="form3Example4cg">Password</label>
                  <input type="password" id="form3Example4cg" class="form-control form-control-lg" require />
                ...
                <div class="form-outline mb-4">
                <label class="form-label" for="form3Example4cdg">select role</label>
                <select class="form-select w-100" aria-label="Default select example">
                  <!-- //'admin', 'operateur', 'client','unverified' -->
